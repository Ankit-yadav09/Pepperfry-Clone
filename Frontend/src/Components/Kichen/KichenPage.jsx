...
export const KichenPage = () => {
  ...
  useEffect(() => {
    fetch(
      `https://naughty-pear-bream.cyclic.app/kitchen/product?sort=${sort}&off=${discount}`
    )
      .then((res) => res.json())
      .then((data) => {
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          ...
          <div>
            ...
            >
              <Checkbox size="lg">Gas Stove</Checkbox>
              <br />
              <Checkbox size="lg">Iron</Checkbox>
              <br />
              <Checkbox size="lg">Grinder </Checkbox>
              <br />
              <Checkbox size="lg">Plate</Checkbox>
              <br />
              <Checkbox size="lg">Glass</Checkbox>
              <br />
              <Checkbox size="lg">Dinner table</Checkbox>
              <br />
            </div>
          </div>
          <hr />
          ...
          <div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              <u style={{ padding: "5px" }}>
                <Text fontSize="md" blockSize="max-content">
                  {units
                    ? Math.round(depth[0] / 20)
                    : Math.round((depth[0] / 20) * 12)}
                  {units ? "ft" : "in"}
                </Text>
              </u>
              <u style={{ padding: "5px" }}>
                <Text fontSize="md" blockSize="max-content">
                  {units
                    ? Math.round(depth[1] / 20)
                    : Math.round((depth[1] / 20) * 12)}
                  {units ? "ft" : "in"}
                </Text>
              </u>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
              ...
              <u style={{ padding: "5px" }}>
                <Text fontSize="md" blockSize="max-content">
                  {units
                    ? Math.round(width[1] / 17)
                    : Math.round((width[1] / 17) * 12)}
                  {units ? "ft" : "in"}
                </Text>
              </u>
            </div>
        ...
        >
          {pageData.length == 0 ? (
            ...
            pageData?.map((ele) => (
              <ProductCard key={ele._id} product={ele} type={type} />
            ))
          )}
        </div>
      </div>
