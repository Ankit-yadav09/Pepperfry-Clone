...
export const HomeDecorPage = () => {
  ...
  useEffect(() => {
    fetch(
      `https://naughty-pear-bream.cyclic.app/kitchen/homeDecor?sort=${sort}&off=${discount}`
    )
      .then((res) => res.json())
      .then((data) => {
      ...
      <div style={{ display: "flex" }}>
        ...
        >
          ...
          <div>
            ...
            >
              <Checkbox size="lg">Bed</Checkbox>
              <br />
              <Checkbox size="lg">Table</Checkbox>
              <br />
              <Checkbox size="lg">Shoe Rag</Checkbox>
              <br />
              <Checkbox size="lg">Bean</Checkbox>
              <br />
              <Checkbox size="lg">Sofa</Checkbox>
              <br />
